...
with lib; let
  ...
  dcName = "regina.windows.catbertsen.de";
  adWorkgroup = "CATA";
  adNetbiosName = "alexandretta";
...
in {
  ...
  security.acme = {
    ...
    certs = {
      "alexandretta.windows.catbertsen.de" = {
