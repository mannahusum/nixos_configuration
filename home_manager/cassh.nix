...
with lib; let
  itivHosts = {
    ...
    "itiv-infopi2" = {
      ...
      hostkeys = [
        "ssh-rsa "
        "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBFNRw88VGgT6Mt5SGe68KYpv29IlJahNMNwnObv9MJ1s0ahyxLW0ih4zvyarbVcjBOBk05DxgGPxpRb3b2KUC0s="
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKBJQwPIZ2mSPj1sKfp6SuOVNPEhl/aBxwZ9Be7ADRxB"
      ];
      overrides = {
        user = "pi";
        proxyJump = "nixos-substitute";
